...
Schedules a task to be invoked on a background thread. $|$expected\-\_\-runtime$|$ indicates that the task will run a long time. The \hyperlink{classv8_1_1Platform}{Platform} implementation takes ownership of $|$task$|$. There is no guarantee about order of execution of tasks wrt order of scheduling, nor is there a guarantee about the thread the task will be run on. \hypertarget{classv8_1_1Platform_a8fa13959f919d1d3ff170bceea939915}{\index{v8\-::\-Platform@{v8\-::\-Platform}!Call\-On\-Foreground\-Thread@{Call\-On\-Foreground\-Thread}}
...
Schedules a task to be invoked on a foreground thread wrt a specific $|$isolate$|$. Tasks posted for the same isolate should be execute in order of scheduling. The definition of \char`\"{}foreground\char`\"{} is opaque to \hyperlink{classv8_1_1V8}{V8}. 
