...
\item 
void \hyperlink{classv8_1_1Isolate_a380d35e0a8dfc8394638fce8ce4c04d4}{Enqueue\+Microtask} (\hyperlink{classv8_1_1Handle}{Handle}$<$ \hyperlink{classv8_1_1Function}{Function} $>$ microtask)
\item 
...
\item 
bool \hyperlink{classv8_1_1Isolate_aea16cbb2e351de9a3ae7be2b7cb48297}{Idle\+Notification} (int idle\+\_\+time\+\_\+in\+\_\+ms)
\item 
void \hyperlink{classv8_1_1Isolate_aaf446f4877e4707a93d2c406fffd9fd6}{Low\+Memory\+Notification} ()
\item 
int \hyperlink{classv8_1_1Isolate_a08d71a6a9979e6105d3c730be56e7702}{Context\+Disposed\+Notification} ()
\item 
...
\item 
bool \hyperlink{classv8_1_1Isolate_ae160d90f70a522dca66b8929762598a2}{Add\+Message\+Listener} (Message\+Callback that, \hyperlink{classv8_1_1Handle}{Handle}$<$ \hyperlink{classv8_1_1Value}{Value} $>$ data=\hyperlink{classv8_1_1Handle}{Handle}$<$ \hyperlink{classv8_1_1Value}{Value} $>$())
\item 
...
\begin{DoxyCompactItemize}
\item 
static \hyperlink{classv8_1_1Isolate}{Isolate} $\ast$ \hyperlink{classv8_1_1Isolate_aeafd7b0add8589d1ab5a992b21a0e826}{New} (const \hyperlink{structv8_1_1Isolate_1_1CreateParams}{Create\+Params} \&params=\hyperlink{structv8_1_1Isolate_1_1CreateParams}{Create\+Params}())
\item 
...
Enables the host application to provide a mechanism to be notified and perform custom logging when \hyperlink{classv8_1_1V8}{V8} Allocates Executable Memory. \hypertarget{classv8_1_1Isolate_ae160d90f70a522dca66b8929762598a2}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Add\+Message\+Listener@{Add\+Message\+Listener}}
...
\end{DoxyParamCaption}
)}\label{classv8_1_1Isolate_ae160d90f70a522dca66b8929762598a2}
...
This method can be used by any thread even if that thread has not acquired the \hyperlink{classv8_1_1V8}{V8} lock with a \hyperlink{classv8_1_1Locker}{Locker} object. \hypertarget{classv8_1_1Isolate_a00790d743cec68bbaa8ca7dbf6257f05}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Clear\+Interrupt@{Clear\+Interrupt}}
...
Clear interrupt request created by $\vert$\+Request\+Interrupt$\vert$. Can be called from another thread without acquiring a $\vert$\+Locker$\vert$. \hypertarget{classv8_1_1Isolate_a08d71a6a9979e6105d3c730be56e7702}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Context\+Disposed\+Notification@{Context\+Disposed\+Notification}}
...
{}
\end{DoxyParamCaption}
)}\label{classv8_1_1Isolate_a08d71a6a9979e6105d3c730be56e7702}
Optional notification that a context has been disposed. \hyperlink{classv8_1_1V8}{V8} uses these notifications to guide the G\+C heuristic. Returns the number of context disposals -\/ including this one -\/ since the last time \hyperlink{classv8_1_1V8}{V8} had a chance to clean up. \hypertarget{classv8_1_1Isolate_a1a5a5762e4221aff8c6b10f9e3cec0af}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Dispose@{Dispose}}
...
Disposes the isolate. The isolate must not be entered by any thread to be disposable. \hypertarget{classv8_1_1Isolate_a380d35e0a8dfc8394638fce8ce4c04d4}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Enqueue\+Microtask@{Enqueue\+Microtask}}
...
\end{DoxyParamCaption}
)}\label{classv8_1_1Isolate_a380d35e0a8dfc8394638fce8ce4c04d4}
...
\end{DoxyNote}
\hypertarget{classv8_1_1Isolate_aea16cbb2e351de9a3ae7be2b7cb48297}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Idle\+Notification@{Idle\+Notification}}
\index{Idle\+Notification@{Idle\+Notification}!v8\+::\+Isolate@{v8\+::\+Isolate}}
\subsubsection[{Idle\+Notification}]{\setlength{\rightskip}{0pt plus 5cm}bool v8\+::\+Isolate\+::\+Idle\+Notification (
\begin{DoxyParamCaption}
\item[{int}]{idle\+\_\+time\+\_\+in\+\_\+ms}
\end{DoxyParamCaption}
)}\label{classv8_1_1Isolate_aea16cbb2e351de9a3ae7be2b7cb48297}
...
Optional notification that the system is running low on memory. \hyperlink{classv8_1_1V8}{V8} uses these notifications to attempt to free memory. \hypertarget{classv8_1_1Isolate_aeafd7b0add8589d1ab5a992b21a0e826}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!New@{New}}
...
\begin{DoxyParamCaption}
\item[{const {\bf Create\+Params} \&}]{params = {\ttfamily {\bf Create\+Params}()}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1Isolate_aeafd7b0add8589d1ab5a992b21a0e826}
...
\hyperlink{classv8_1_1V8_a40daec93ce44bdd922567fc121be9db8}{V8\+::\+Initialize()} must have run prior to this. \hypertarget{classv8_1_1Isolate_a46f0a5d35f8b29030922bdb433c0dc4f}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Remove\+Call\+Completed\+Callback@{Remove\+Call\+Completed\+Callback}}
...
This should only be used for testing purposes and not to enforce a garbage collection schedule. It has strong negative impact on the garbage collection performance. Use \hyperlink{classv8_1_1Isolate_aea16cbb2e351de9a3ae7be2b7cb48297}{Idle\+Notification()} or \hyperlink{classv8_1_1Isolate_aaf446f4877e4707a93d2c406fffd9fd6}{Low\+Memory\+Notification()} instead to influence the garbage collection schedule. \hypertarget{classv8_1_1Isolate_a971b6094ecc6c7f55eb6f58a71a8afd3}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Request\+Interrupt@{Request\+Interrupt}}
...
Set the callback to invoke to check if code generation from strings should be allowed. \hypertarget{classv8_1_1Isolate_a6c046eb1d5ab19ef11c18c2f6e775df1}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Autorun\+Microtasks@{Set\+Autorun\+Microtasks}}
...
Set the callback to invoke for logging event. \hypertarget{classv8_1_1Isolate_ab9ef29fc049d82e0c33994632b4f6ba6}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Failed\+Access\+Check\+Callback\+Function@{Set\+Failed\+Access\+Check\+Callback\+Function}}
...
Set the callback to invoke in case of fatal errors. \hypertarget{classv8_1_1Isolate_a71d976355bf47eb2dd09cd5d1279a40d}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Jit\+Code\+Event\+Handler@{Set\+Jit\+Code\+Event\+Handler}}
...
Set callback to notify about promise reject with no handler, or revocation of such a previous notification once the handler is added. \hypertarget{classv8_1_1Isolate_a055fc73d18747b96c51f00599cdd3ec1}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Reference@{Set\+Reference}}
